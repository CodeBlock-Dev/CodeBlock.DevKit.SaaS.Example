...
/// <summary>
/// Use case for adding a new Fact to a Page.
...
internal class AddFactUseCase : BaseCommandHandler, IRequestHandler<AddFactRequest, CommandResult>
{
    ...
    /// <summary>
    /// Initializes a new instance of the AddFactUseCase with the required dependencies.
    /// </summary>
    ...
    public AddFactUseCase(
        IPageRepository pageRepository,
        IRequestDispatcher requestDispatcher,
        ILogger<AddFactUseCase> logger
    )
    ...
    /// <summary>
    /// Handles the addition of a new fact to a page.
    ...
    /// </summary>
    /// <param name="request">The command request containing the fact data</param>
    /// <param name="cancellationToken">Cancellation token for the operation</param>
    /// <returns>A command result with the ID of the created fact</returns>
    ...
    public async Task<CommandResult> Handle(AddFactRequest request, CancellationToken cancellationToken)
    {
        ...
        var fact = page.AddFact(request.Content);
